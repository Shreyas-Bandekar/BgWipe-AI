        ...
        <div className='flex item-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div >
                ...
                <div>
                    ...
                    <label className='inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-blue-600 to to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700 ' htmlFor="upload1">
