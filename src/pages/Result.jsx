    ...
    <div className='mx-4 my-3 lg:mx-44 mt-14 min-h-[72vh]'>
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
        ...
        <div className='flex flex-col sm:flex-row justify-center sm:justify-end items-center gap-4 mt-8 flex-wrap'>
          <button
            className="px-8 py-2.5 text-sm text-fuchsia-600 border border-fuchsia-500 rounded-full hover:scale-105 transition-all duration-700"
          >
            Try another image
          </button>
          <a
            href=""
            className="px-8 py-2.5 text-white text-sm bg-gradient-to-r from-blue-600 to to-fuchsia-500 rounded-full hover:scale-105 transition-all duration-700"
            download
          >
            Download Image
          </a>
