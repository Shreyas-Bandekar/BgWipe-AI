    ...
    <div className='pb-16'>
        ...
        <div className='text-center mb-24'>
            <input type="file" name='' id='upload2' hidden />
                <label className='inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-blue-600 to to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700 ' htmlFor="upload2">
